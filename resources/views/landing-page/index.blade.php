...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <a href="{{route('home')}}" class="navbar-brand mx-auto mx-lg-0">Ki.dev</a>

            <div class="d-flex align-items-center d-lg-none">
                <a class="custom-btn btn custom-link" href="#section_2">Download CV</a>
            </div>
                    ...
                    <div class="col-lg-12 col-12 justify-content-center align-items-center">
                        <div class="hero-text">
                            ...
                            <div class="d-flex flex-row justify-content-center mb-3 gap-3">
                                ...
                                <div class="p-4 rounded-circle btn btn-light">
                                    <a href="https://www.linkedin.com/in/fangkiigopramana">
                    ...
                    <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                        <div class="about-thumb">
                            ...
                            <p>
                                ...
                                Fullstack Web Development, particularly with the Laravel framework. I have honed my skills in various
                                programming languages and frameworks, delivering efficient solutions to complex problems. My hands-on
                                experience in web development projects has given me a deep understanding of the entire development lifecycle.
                                I am passionate about continuously learning and staying updated with the latest industry trends. Currently, I am
                                seeking opportunities to contribute to innovative projects and further develop my skills.
                            </p>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="section-title-wrap align-items-start w-50">
                        <h2 class="text-white text-start mb-0">Experiences</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="section-title-wrap align-items-start mb-4 w-50">
                        <h2 class="text-white text-start mb-0">Projects</h2>
                    </div>
                </div>
                <div class="row">
